...
the \code{-Aflow} option will enable the Tainting Checker to check for instances of indirect information flow. Consider
...
Tainting Checker searches for such comparisons and raises an error when the \code{-Aflow} option is provided.
